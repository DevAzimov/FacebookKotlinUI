...
import com.magicapp.facebookkotlinui.actyivity.CreatePostActivity
import com.magicapp.facebookkotlinui.actyivity.MainActivity
...
class FeedAdapter(var context: MainActivity, var feeds: ArrayList<Feed>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        if (viewType == TYPE_ITEM_HEAD) {
            ...
            val view = LayoutInflater.from(context).inflate(R.layout.item_feed_link_post, parent, false)
